...
int main(int argc, char* argv[]) {
	...
	/* !!!! VM1 main code !!!! */
	sendFrameTo(target, 0xFFFD, "Hi Hello AnnyeongHaSeYo !!!!!!!2019320061!!!!!!!", 
	strlen("Hi Hello AnnyeongHaSeYo !!!!!!!2019320061!!!!!!!")); // When you write your student code, delete !!!!!!!!
